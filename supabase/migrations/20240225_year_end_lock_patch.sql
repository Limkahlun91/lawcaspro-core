...
BEGIN
    ...
    -- 2. Lock Firm Row (Prevent Concurrent Year Close execution for the same firm)
    PERFORM 1 FROM firms WHERE id = v_firm_id FOR UPDATE;

    -- 3. Validate Year Status
    ...
    -- 4. Strict 12-Month Period Validation (Distinct Months)
    ...
    -- 6. Lock GL Entries for Calculation
    ...
    -- 8. Create Closing Journal Entry
    ...
    -- 11. Post Net Profit/Loss to Retained Earnings
